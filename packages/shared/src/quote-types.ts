import type { ModelConfig } from "./quote-schema";

// Zod-free on purpose: the browser imports these constants on every page, and
// importing zod here would ship it there too. The schemas live in
// quote-schema.ts (a guard test keeps it this way: client-safe.test.ts).
export type { Customer, ModelConfig, SliceSettings } from "./quote-schema";
