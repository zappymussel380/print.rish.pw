...
export default async function SettingsPage() {
  ...
  const [shipping, retention] = await Promise.all([getShippingConfig(), getRetention()]);
  return (
    <>
      <AdminPageHeader title="Settings" lede="Courier estimates on the quote page, and how long uploads and old quotations are kept." />
